...
public class ProductPage {
    ...
    private By categoryClick = By.xpath("//div[contains(text(),'Computer & Accessories')]");
    private By categorySelect = By.xpath("//span[normalize-space()='Computer & Accessories']");
    ...
    private By videoProviderClick = By.xpath("//div[contains(text(),'Youtube')]");
    ...
    private By colorSelect = By.xpath("//span[contains(text(),'DarkRed')]");
    ...
    private By attributesSelect = By.xpath("//span[normalize-space()='Fabric']");

    // private By fabricClick = By.xpath("//button[@title='Fabric']")).click();
    ...
    private By fabricSelect = By.xpath("//span[normalize-space()='Cotton']");

    //  private By abcd = By.xpath("//button[@title='Cotton']")).click();

    private By flashClick = By.xpath("//div[contains(text(),'Choose Flash Title')]");

    private By flashSelect = By.xpath("//span[normalize-space()='Electronic']");
    ...
    private By discountTypeSelect = By.xpath("//a[@id='bs-select-8-2']//span[@class='text'][normalize-space()='Percent']");
    ...
    private By taxTypeSelect = By.xpath("//a[@id='bs-select-9-1']//span[@class='text'][normalize-space()='Percent']");

  //  private By statusClick = By.xpath("(//label[normalize-space()='Status']/following-sibling::div//label[@class='aiz-switch aiz-switch-success mb-0'])[2]");
    ...
    private By discountStyleSelect = By.xpath("//span[normalize-space()='Percent']");
    ...
    public void enterProductData() {
        ...
        WebUI.setElementText(productName, "HaiMai_Product");
        ...
        // private By fabricSearch = By.xpath("//div[@class='dropdown-menu show']//input[@aria-label='Search']")).click();
    ...
    //    WebUI.clickElement(statusClick);
